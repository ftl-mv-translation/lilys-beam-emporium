...
local defense_types = {
    ...
    MISSILES = { [1] = true, [2] = true, [5] = true, name = "Tous les projectiles solides" },
    DRONES_MISSILES = { [1] = true, [2] = true, [3] = true, [5] = true, name = "Tous les projectiles solides et Drones" },
    PROJECTILES = { [4] = true, name = "Projectiles Non-solides" },
    PROJECTILES_MISSILES = { [1] = true, [2] = true, [4] = true, [5] = true, name = "Tous les projectiles" },
    ALL = { [1] = true, [2] = true, [3] = true, [4] = true, [5] = true, name = "Tout" },
}
